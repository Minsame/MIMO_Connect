...
_STRINGS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "settings_group_tts": "MiMo 语音合成（TTS）",
        "field_tts_voice": "音色",
        "field_tts_model": "TTS 模型",
        "tts_keep_current": "（保持当前）",
        "settings_hint": "保存后若引擎正在运行，将询问是否立即重启以生效。",
        "settings_lang_restart": "语言已切换，部分界面需重新打开窗口后完全生效。",
        "missing_key_title": "缺少 API key",
        "missing_key_body": "请填写所选提供商的 API key。",
        "saved_title": "已保存",
        "saved_body": "配置已保存。",
        "restart_now_title": "重启引擎",
        "restart_now_body": "配置已保存。引擎正在运行，是否立即重启以应用新配置？",
    ...
    "en": {
        ...
        "settings_group_tts": "MiMo Text-to-Speech (TTS)",
        "field_tts_voice": "Voice",
        "field_tts_model": "TTS model",
        "tts_keep_current": "(keep current)",
        "settings_hint": "After saving, if the engine is running you will be asked to restart it now.",
        ...
        "restart_now_title": "Restart engine",
        "restart_now_body": "Settings saved. The engine is running; restart now to apply the new configuration?",
